        ...
        <div class="content-wrapper">
            ...
            <div class="container mt-5">
                ...
                <form method="POST">
                    ...
                    <input type="text" name="lokasi_terminal"
                        value="<?= htmlspecialchars($terminal['lokasi_terminal']) ?>" required>
                    <br>
                    <label>Nama Terminal:</label>
                    <input type="text" name="nama_terminal" value="<?= htmlspecialchars($terminal['nama_terminal']) ?>"
                        required>
                    <br>
