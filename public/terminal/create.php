            ...
            <div class="container mt-5">
                ...
                <form method="POST">
                    <table class="table table-bordered">
                        <tr>
                            <td><label for="lokasi_terminal">Lokasi Terminal:</label></td>
                            <td><input type="text" id="lokasi_terminal" name="lokasi_terminal" required></td>
                        </tr>
                        <tr>
                            <td><label for="nama_terminal">Nama Terminal:</label></td>
                            <td><input type="text" id="nama_terminal" name="nama_terminal" required></td>
                        </tr>
                        <tr>
