...
if ($id > 0) {
  $stmt = $pdo->prepare("SELECT * FROM bandara WHERE id = :id");
  $stmt->bindParam(':id', $id, PDO::PARAM_INT);
  $stmt->execute();

  $bandara = $stmt->fetch(PDO::FETCH_ASSOC);
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="edit_process.php" method="POST">
          <input type="hidden" name="id" value="<?= $bandara['id']; ?>">
          <div class="form-group">
            <label>Nama Bandara</label>
            <input type="text" name="nama" class="form-control" value="<?= $bandara['nama']; ?>" required>
          </div>
          <div class="form-group">
            <label>ISO 9001</label>
            <input type="checkbox" name="iso_9001" value="1" <?= $bandara['iso_9001'] ? 'checked' : ''; ?>>
          </div>
