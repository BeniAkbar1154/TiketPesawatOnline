                ...
                <div class="col-lg-10 border rounded p-1">
                    <div class="border rounded text-center p-1">
                        <div class="bg-white rounded text-center p-5">
                            <h4 class="mb-4"><span class="text-primary text-uppercase">Login</span></h4>
                            <?php if (isset($error)): ?>
                            ...
                            <form method="POST">
                                ...
                                <button type="submit" class="btn btn-primary py-2 px-4 mt-2">Login</button>
                            </form>
                            <div class="mt-4">
                                <a href="register.php" class="btn btn-secondary py-2 px-4">Register</a>
