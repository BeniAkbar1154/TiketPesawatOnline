...
$sql = "SELECT id, username, email, level FROM users"; // Sesuaikan nama tabel dan kolom
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <!-- Button Logout -->
        <!-- <a href="/FinalProject/public/register/logout.php" class="btn btn-danger">Logout</a> -->
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    ...
                                    <a href='delete.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus user ini?\");'>Delete</a>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
...
<!-- OPTIONAL SCRIPTS -->
<script src="/FinalProject/public/adminlte/plugins/chart.js/Chart.min.js"></script>
<!-- AdminLTE for demo purposes -->
<!-- <script src="/FinalProject/public/adminlte/dist/js/demo.js"></script> -->
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="/FinalProject/public/adminlte/dist/js/pages/dashboard3.js"></script>
</body>
</html>
