...
<!-- /.sidebar -->
    ...
    <div class="content-wrapper">
        <div class="content-header">
            ...
            <a href="create.php" class="btn btn-success">Tambah Pesawat</a>
        </div>
        ...
        <section class="content">
            <table class="table table-bordered">
                ...
                <tbody>
                    <!-- Looping data pesawat dari database -->
                    <?php foreach ($pesawatData as $pesawat): ?>
                        <tr>
                            <td><?= $pesawat['id']; ?></td>
                            <td><img src="/FinalProject/public/uploads/<?= $pesawat['gambar']; ?>" width="100"></td>
                            <td><?= $pesawat['nama']; ?></td>
                            <td><?= $pesawat['tipe']; ?></td>
                            <td><?= $pesawat['deskripsi']; ?></td>
                            <td><?= $pesawat['kapasitas']; ?></td>
                            <td>
                                <a href="edit.php?id=<?= $pesawat['id']; ?>" class="btn btn-warning">Edit</a>
                                <a href="delete.php?id=<?= $pesawat['id']; ?>" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
